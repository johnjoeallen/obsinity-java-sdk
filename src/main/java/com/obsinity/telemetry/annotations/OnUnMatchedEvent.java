 ...
 *
 * <p>scope: - COMPONENT: runs when this component had no @OnEvent match for the in-scope event. - GLOBAL: runs only if
 * no @OnEvent matched in any component.
 *
 * <p>lifecycle: empty = any mode: SUCCESS / FAILURE / COMBINED
 */
