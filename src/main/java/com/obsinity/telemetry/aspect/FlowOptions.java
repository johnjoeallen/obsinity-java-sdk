 ...
 *
 * <ul>
 *   <li>For {@code @Flow}: {@code annotation=FLOW}, {@code name} populated, {@code autoFlowLevel=null}.
 *   <li>For {@code @Step}: {@code annotation=STEP}, {@code name} populated, {@code autoFlowLevel} set if
 *       {@code @AutoFlow} is present on the same method (else {@code null}).
 *   <li>For {@code @AutoFlow}-only scenarios (rare to advise directly): {@code annotation=AUTOFLOW},
 *       {@code autoFlowLevel} populated, {@code name=null}.
 * </ul>
 */
