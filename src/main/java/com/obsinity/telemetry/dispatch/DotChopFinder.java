...
public final class DotChopFinder {
	...
	/**
	 * Iteratively looks up eventName and its dot-chopped ancestors in the map.
	 * Example: orders.checkout.details -> try:
	 *   "orders.checkout.details", "orders.checkout", "orders"
	 * Returns null if nothing found (empty string is never queried).
	 */
	...
	/**
	 * True if ancestorKey matches eventName by dot-chop:
	 * exact match OR eventName starts with ancestorKey + "."
	 */
