...
/**
 * Simple logging receiver for the new flow-centric model: - Logs component-scoped unmatched events
 * via @OnFlowNotMatched.
 */
@EventReceiver
public class LoggingTelemetryEventHandler {
	...
	/** Fires when no named @OnFlow */
	// (success/failure/completed) matched within this component.
	@OnFlowNotMatched
